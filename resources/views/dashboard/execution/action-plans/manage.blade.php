                    ...
                    @if($items->isEmpty())
                        <tr>
                            <td colspan="7" class="px-4 py-8 text-center text-gray-500">
                                ...
                                <p class="text-sm">Agrega items desde la vista de edición del plan.</p>
                            </td>
                        </tr>
                    @else
                        {{-- Debug temporal: mostrar cantidad --}}
                        <tr><td colspan="7" class="px-4 py-2 bg-yellow-50 text-center font-semibold">✓ Se encontraron {{ $items->count() }} items para mostrar</td></tr>
                    @endif
