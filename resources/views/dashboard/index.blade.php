...
@section('content')
<!-- 🔍 DEBUG: Este es el archivo dashboard/index.blade.php -->
<div class="mb-4 p-4 bg-yellow-100 border-2 border-yellow-500 rounded-lg">
    <p class="text-yellow-900 font-bold text-lg">🔍 ARCHIVO: dashboard/index.blade.php</p>
    <p class="text-yellow-700 text-sm">Si ves este mensaje, estás en el archivo INCORRECTO para /dashboard/planning</p>
    @if(auth()->check())
