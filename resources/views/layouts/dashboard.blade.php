        ...
        <aside id="sidebar" class="sidebar bg-gradient-to-b from-[#1e3a5f] via-[#2c4f7c] to-[#1a2f4d] shadow-2xl flex flex-col border-r border-blue-800/30">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <div class="pt-6">
                    ...
                    <a href="{{ route('dashboard.components') }}" class="nav-item {{ request()->routeIs('dashboard.components') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                        </svg>
                        <span>Gestión de Componentes</span>
                    </a>

                    <a href="{{ route('dashboard.documents') }}" class="nav-item {{ request()->routeIs('dashboard.documents') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                    ...
                    <a href="{{ route('dashboard.timeline') }}" class="nav-item {{ request()->routeIs('dashboard.timeline') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
